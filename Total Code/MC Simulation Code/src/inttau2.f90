    ...
    !
        ...
        do
            ...
            if(taurun + taucell < tau)then!still some tau to move
                ...
                jmean(celli, cellj, cellk) = jmean(celli, cellj, cellk) + dcell*rhokap(celli,cellj,cellk) ! records deposited energy
            ...
            if(celli == -1 .or. cellj == -1 .or. cellk == -1)then!photon left medium
                    tflag = .true.
                    exit
            end if
        end do
